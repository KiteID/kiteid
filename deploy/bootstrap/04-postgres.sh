...
echo ""
echo "Credentials written to $CRED_FILE (chmod 600). NOT echoed here to avoid"
echo "secret exposure via captured transcripts / shell history / monitoring."
echo "Read them with:  sudo cat $CRED_FILE"
echo ""
